...
Node *findMIdLinkList(Node *&head)
{
    int lenght = lenghtofLinkList(head);
    int mid;
...
// ==============Print  MId Link List=============================================== //
// ============================================================================ //
void printMIdAddressAndValue(Node *&head)
{
    Node *temp = findMIdLinkList(head);

    cout << endl
         << endl
         << " Mid Address : " << temp << endl 
         << " Mid Value : " << temp->data
         << endl
         << endl;
}
...
int main()
{
    ...
    /*Insert at first*/
    insertAtAnyPostion(head, tail, 1, 80);
    printLinkList(head);
    printMIdAddressAndValue(head);
