...
void removeDuplicateInSortedLinklist(Node *&head)
{
    Node *temp = head;
...
int main()
{
    ...
    cout << endl
         << endl
         << "<- ReMove same in SOrted ARRAY ->" << endl
         << endl;

    removeDuplicateInSortedLinklist(head);
    cout << "<- ReMove same in SOrted ARRAY ->" << endl;
    printLinkList(head);
}